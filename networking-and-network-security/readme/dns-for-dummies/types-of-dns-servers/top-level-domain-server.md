...
A top-level domain (TLD) is one of the [domains](../../../networking-basics/dns-for-dummies/#what-is-a-domain-name) at the highest level in the hierarchical [Domain Name System](../../../networking-basics/dns-for-dummies/#so-what-is-a-dns), after the root domain.
